...
int x=18,y=3;
Console.WriteLine($"The sum of {x} and {y} is {operation.Sum(x,y)}");// calling sum function
...
Console.WriteLine($"The multiplication of {x} and {y} is {operation.Multiply(x, y)}");//calling multiplication function
